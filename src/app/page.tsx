    ...
    <div style={{ ...glass, width:'100%', maxWidth:680, overflow:'hidden', textAlign:'left' }}>
      ...
      <div style={{ padding:20 }}>
        ...
        {result && result.found.length>0 && <>
          ...
          <div style={{ marginTop:12, padding:'10px 14px', background:'rgba(10,132,255,0.08)', border:'1px solid rgba(10,132,255,0.15)', borderRadius:10, fontSize:12, color:'rgba(255,255,255,0.6)', lineHeight:1.5 }}>
            💡 <strong style={{ color:'#fff' }}>Create your free account</strong> to get this protection on every AI prompt automatically — ChatGPT, Claude, Gemini, Copilot and more.
          </div>
        </>}
      </div>
    </div>
    ...
    <div style={{ fontFamily:'-apple-system,BlinkMacSystemFont,SF Pro Display,Inter,sans-serif', color:'#fff', background:'#1C1C1E', minHeight:'100vh' }}>
        ...
        <div style={{ maxWidth:720, margin:'0 auto' }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:3 }}>
            {[
              ...
              { icon:'🛡️', title:'GC Protect intercepts before it sends', desc:'In under a second, every sensitive field is replaced with a cryptographically unique token. A new random token every time — no patterns, no reuse.', code:{ bad:false, text:'Customer: GC-C9K2P4M\nSSN: GC-IDX8R2Q1\nEmail: GC-EM3T7K9\nOrder: GC-SAL2M8R' } },
              ...
              { icon:'🚩', title:'Safety flagging built in', desc:'Harmful content — self-harm, threats, dangerous requests — is detected, crisis resources surfaced, and the event logged for admin review.', code:null },
      ...
      <section id="pricing" style={{ position:'relative', zIndex:1, padding:'100px 5vw' }}>
        <div style={{ maxWidth:760, margin:'0 auto' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))', gap:16 }}>
            ...
            <div style={{ ...glass, padding:'28px 24px', borderRadius:20, position:'relative' as const, overflow:'hidden' }}>
              ...
              <div style={{ position:'absolute', inset:0, backdropFilter:'blur(6px)', WebkitBackdropFilter:'blur(6px)', zIndex:2, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', background:'rgba(28,28,30,0.6)', borderRadius:20 }}>
                ...
                <a href="mailto:hello@gratiacore.com?subject=Team Plan Waitlist" style={{ marginTop:16, background:'rgba(255,255,255,0.12)', color:'#fff', border:'1px solid rgba(255,255,255,0.2)', padding:'10px 22px', borderRadius:10, fontSize:13, fontWeight:600, textDecoration:'none' }}>
                  Join Waitlist
                </a>
              </div>
          ...
          <p style={{ marginTop:24, fontSize:14, color:'rgba(255,255,255,0.3)' }}>
            Enterprise? <a href="mailto:hello@gratiacore.com" style={{ color:'#0A84FF', textDecoration:'none' }}>Contact us</a>
          </p>
        </div>
      </section>
      ...
      <footer style={{ position:'relative', zIndex:1, borderTop:'1px solid rgba(255,255,255,0.07)', padding:'32px 5vw', display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap' as const, gap:16 }}>
        ...
        <div style={{ display:'flex', gap:24 }}>
          {[['Privacy Policy','/privacy'],['Terms','/terms'],['Install Guide','/install'],['Support','mailto:hello@gratiacore.com']].map(([label,href])=>(
